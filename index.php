      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          ?>
              ...
              <li><a class="nav-link scrollto" href="#about">Alta</a></li>
              <li><a class="nav-link scrollto" href="#services">Iniciar Sesion</a></li>
          <?php
            }elseif(isset($_SESSION['usuario'])){
          ?>
              <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
              <li><a class="nav-link scrollto" href="#about">Reservar</a></li>
              <li><a class="nav-link scrollto" href="#services">Mis fiestas</a></li>
              <li><a class="nav-link scrollto " href="#portfolio">Cerrar Sesion</a></li>
          <?php
            }elseif(isset($_SESSION['admin'])){
          ?>
              <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
              <li><a class="nav-link scrollto" href="#about">Crear BD</a></li>
              <li><a class="nav-link scrollto" href="#services">Borrar BD</a></li>
              <li><a class="nav-link scrollto " href="#portfolio">Alta Empleado</a></li>
              <li><a class="nav-link scrollto" href="#pricing">Baja Empleado</a></li>
              <li class="dropdown"><a href="#"><span>Consultas</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  <li><a href="#">Animadores</a></li>
                  <li><a href="#">Todas las fiestas</a></li>
                  <li><a href="#">Fiestas segun cliente</a></li>
                </ul>
              </li>         
              <li><a class="nav-link scrollto " href="#portfolio">Cerrar Sesion</a></li>
          <?php
